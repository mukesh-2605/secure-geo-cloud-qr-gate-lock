...
MultipartParser mp =new MultipartParser(request, 999999999);
		...
		String fullpath=editpath+"ITJBC04\\WebContent\\Locals\\";
	...
	//file encrypted and store into filepath1
             ...
             filepath1 = editpath + "\\ITJBC04\\WebContent\\Encrypt\\"+filename;
              ...
              //file decrypted and store into filepath2
        		    ...
        		    filepath2 = editpath + "\\ITJBC04\\WebContent\\Decrypt\\"+filename;
     ...
     filepath1 = editpath + "\\ITJBC04\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
          ...
          up.setTlmail(paramValues.get(4).toString());
          System.out.println("tlmail: "+paramValues.get(4));
          
          
        up.setTeam(paramValues.get(6).toString());
