...
<button onclick="history.back();" class="btn btn-outline-warning" style="float:right;">Back</button>
<body>


  <div class="container">
    <h3 style="font-weight: bold; text-align: center;margin-top: 10px;color:white">New Team Leader...!!!</h3><br>
    <form method="post" action="TlregServlet" enctype="multipart/form-data">
     <div class="row">
       <div class="card col-sm-6" style="padding-bottom:10px;background-color: #333;color:#fff;padding:10px;margin-left:26%;width: 27em;margin-bottom: 25px">
