...
<% String teams=request.getParameter("teammember"); %>
       <%
       ...
       con=dbconn.create();
       PreparedStatement ps=con.prepareStatement("SELECT * FROM `bc04`.`staffreg` where team='"+teams+"'  ");
...
<div class="card">
	  ...
	  <p class="card-text"><strong><center><span style="color:blue; font-family:bold;"><%=rs.getString(8)%></span></center></strong></p>   
